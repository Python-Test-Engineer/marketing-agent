...
A **content strategy** is the backbone of all sustainable marketing. It defines *what* you create, *for whom*, *where* it lives, and *how* it drives business outcomes.
...
```
Audience Research → Brand Voice → Content Calendar → Distribution → Metrics → (repeat)
```
...
| Framework | Best For |
|-----------|----------|
| TOFU/MOFU/BOFU | Funnel-stage mapping |
| Pillar + Cluster | SEO content architecture |
| Hero/Hub/Hygiene | Video/social content planning |
| Jobs-to-be-Done | Audience need identification |

> **North Star:** Every content decision should serve the audience first, the algorithm second, and the brand third.
