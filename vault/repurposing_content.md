...
```
    ...
    📋 Checklist / template (lead magnet)
    ❓ FAQ / Quora answers
    🗣 Talk abstract / webinar pitch
```

## Repurposing Matrix

| Source Format | → Blog Post | → Social | → Email | → Video | → Lead Magnet |
|---------------|------------|---------|---------|---------|--------------|
| Long blog post | ✂️ Update & re-publish | Carousel + thread | Newsletter section | Talking-head recap | Checklist extract |
| Podcast episode | Full transcript → post | Quote audiogram | Top 3 takeaways | Audio + B-roll | Summary PDF |
| Webinar | Recording → YouTube | Clip highlights | Replay email | Full video + Shorts | Slide deck |
| Research report | Summary post | Data charts | Key finding email | Data storytelling | Full report PDF |
...
| Type | Repurposing Approach |
|------|---------------------|
| **Evergreen** | Update annually, re-promote quarterly, extract new formats |
| **Timely** | Fast derivatives (social posts, email) within 24–48 hours of publish |
...
| Task | Tool |
|------|------|
| Video → clips | Descript, Opus Clip |
| Blog → social posts | Typefully, Taplio |
| Audio → transcript | Descript, Otter.ai |
| Visuals / carousels | Canva, Adobe Express |
