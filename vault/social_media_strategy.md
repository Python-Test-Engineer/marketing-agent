...
|----------|----------|---------------|-------------------|
| LinkedIn | B2B, thought leadership | Long text, carousels, short video | 3–5x/week |
| Twitter/X | Real-time, tech/startup culture | Short text, threads, images | 1–3x/day |
| Instagram | Visual brands, B2C, lifestyle | Reels, carousels, Stories | 4–7x/week |
| YouTube | Education, product demos | Long-form video, Shorts | 1–2x/week |
| TikTok | Gen Z, B2C, discovery | Short video | 1–3x/day |
...
3. **Behind-the-scenes** — Culture, process, people (builds connection)
4. **Promotional** — Offers, launches, CTAs (drives revenue)
5. **Engagement** — Questions, polls, debates (drives community)

## The 4-1-1 Rule

For every **6 posts**:
- **4** educate or entertain (audience-first value)
- **1** share someone else's content (community-building)
- **1** promote your own offer or content

## Algorithm Principles (Platform-Agnostic)

- Prioritize **native content** (upload video directly, don't share links on feed)
